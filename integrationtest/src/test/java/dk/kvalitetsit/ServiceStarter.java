...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("fut-medarbejder-bff");
    ...
    public GenericContainer<?> startServicesInDocker() {
        ...
        var resourcesContainerName = "fut-medarbejder-bff-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/fut-medarbejder-bff-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("fut-medarbejder-bff")
